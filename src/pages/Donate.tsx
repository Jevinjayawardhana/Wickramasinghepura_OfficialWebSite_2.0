      ...
      <section className="relative min-h-[60vh] flex items-center overflow-hidden bg-secondary text-secondary-foreground">
        ...
        <div className="container-editorial relative z-20 py-20">
          <Reveal>
            ...
            <h1 className="font-serif text-5xl md:text-8xl mt-6 leading-[0.9] tracking-tighter">Small acts. <br /><span className="text-primary italic">Big impact.</span></h1>
        ...
        <div className="grid grid-cols-12 gap-12 lg:gap-20">
          <div className="col-span-12 lg:col-span-7 space-y-10">
            <Reveal animation="fade-in-left">
              ...
              <div className="grid sm:grid-cols-2 gap-6 mt-12">
                <div className="p-6 bg-secondary text-secondary-foreground shadow-editorial border-l-4 border-accent">
                ...
                <div className="p-6 bg-secondary text-secondary-foreground shadow-editorial border-l-4 border-primary">
          ...
          <div className="col-span-12 lg:col-span-5 relative">
            <Reveal animation="fade-in-right" delay={200} className="lg:sticky lg:top-32">
              <div className="bg-secondary text-secondary-foreground p-8 md:p-12 shadow-2xl relative overflow-hidden group border border-white/5">
                ...
                <div className="relative z-10">
                  ...
                  <div className="space-y-8">
                    <div><label className="text-[10px] uppercase tracking-[0.2em] text-accent font-black block mb-2 opacity-70">Account Name</label><p className="text-lg font-medium">Leo Club of Wickramasinghepura</p></div>
                    <div><label className="text-[10px] uppercase tracking-[0.2em] text-accent font-black block mb-2 opacity-70">Bank & Branch</label><p className="text-lg font-medium">Commercial Bank – Bambalapitiya Branch</p></div>
                    <div className="pt-8 border-t border-white/10">
                      <label className="text-[10px] uppercase tracking-[0.2em] text-primary font-black block mb-2">Account Number</label>
                      <p className="text-4xl md:text-5xl font-serif text-primary tracking-tighter">8011659866</p>
                    </div>
                  </div>
                </div>
              </div>
